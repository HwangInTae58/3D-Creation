...
public class Boss : Character, IDamaged
{
    ...
    private void FindTarget()
    {
        ...
        else
        {
            ...
            if (attackedFarTarget.Length > 0 && attackedCloseTarget.Length <= 0)
            {
                ...
                SoundPool.instance.SetSound(audioClip[3], flamePos, 0.5f, false, true);
    ...
    private void MoveDelay()
    {
        ...
        {
            isStart = true;
            SoundPool.instance.SetSound(audioClip[0], gameObject.transform, 3f, false, true);
    ...
    {
        SoundPool.instance.SetSound(audioClip[1], effectPos, 3f, false, true);
